...
export default function TagPostsPage({ params }: { params: Promise<{ tag: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-8 pt-[66px]">
      <div className="container mx-auto px-4">
        ...
        <h1 className="text-3xl font-bold mb-8 text-foreground mt-4">标签: {tag}</h1>
        
        {posts.length === 0 ? (
          <p className="text-muted-foreground">暂无标签为 &quot;{tag}&quot; 的文章。</p>
        ) : (
