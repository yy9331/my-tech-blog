...
const WriteLayoutContent = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <form className="max-w-5xl mx-auto pt-8" onSubmit={handleSave}>
        {/* 折叠表单区 */}
        <div className="mb-6 mt-[66px]">
          ...
          <div
            className={`overflow-hidden transition-all duration-300 bg-gray-800 rounded-b-lg ${collapsed ? 'max-h-0 py-0 px-0' : 'max-h-[500px] py-6 px-6'}`}
          >
            {!collapsed && (
